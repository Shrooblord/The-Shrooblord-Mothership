...
sMConf = {}
    ...
    sMConf[0] = {
        ...
        override = true,   --when true, the settings in this configuration file override the settings in all other mods' config files where possible  
        develop = true,    --development/debug mode
